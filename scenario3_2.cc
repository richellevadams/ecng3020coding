...
//Access Network 1
  ...
  IpcsClassifierRecord UlClassifierBe12 (SSinterfaces1.GetAddress (2),
                                        Ipv4Mask ("255.255.255.255"),
                                        Ipv4Address ("0.0.0.0"),
                                        Ipv4Mask ("0.0.0.0"),
                                        0,
                                        ...
                                        17,
                                        1);
  ServiceFlow UlServiceFlowBe12 = wimax1.CreateServiceFlow (ServiceFlow::SF_DIRECTION_UP,
                                                          ServiceFlow::SF_TYPE_BE,
                                                          UlClassifierBe12);
...
//Access Network 2
 ...
 IpcsClassifierRecord UlClassifierBe22 (SSinterfaces2.GetAddress (2),
                                        Ipv4Mask ("255.255.255.255"),
                                        Ipv4Address ("0.0.0.0"),
                                        Ipv4Mask ("0.0.0.0"),
                                        0,
...
//ServiceFlow::SF_TYPE_RTPS.
  ...
  IpcsClassifierRecord UlClassifierBe32 (SSinterfaces3.GetAddress (2),
                                        Ipv4Mask ("255.255.255.255"),
                                        Ipv4Address ("0.0.0.0"),
                                        Ipv4Mask ("0.0.0.0"),
                                        0,
...
uint16_t port = 80;
NS_LOG_INFO ("Adding http traffic: s13->ue13");
  HttpHelper httpHelper_s13_ue13;
  HttpServerHelper httpServer_s13_ue13;  

  httpServer_s13_ue13.SetAttribute ("Local", AddressValue (InetSocketAddress (Ipv4Address::GetAny (), port)));
  httpServer_s13_ue13.SetAttribute ("HttpController", PointerValue (httpHelper_s13_ue13.GetController ()));
  ApplicationContainer httpServerApps_s13_ue13 = httpServer_s13_ue13.Install (s13);
  httpServerApps_s13_ue13.Start (Seconds (0.0));
  httpServerApps_s13_ue13.Stop (Seconds (20.0));

  HttpClientHelper httpClient_s13_ue13;
  httpClient_s13_ue13.SetAttribute ("Peer", AddressValue (InetSocketAddress (interfaces_r1_s13.GetAddress (1), port)));
  httpClient_s13_ue13.SetAttribute ("HttpController", PointerValue (httpHelper_s13_ue13.GetController ()));
  ApplicationContainer httpClientApps_s13_ue13 = httpClient_s13_ue13.Install (ue13);
  httpClientApps_s13_ue13.Start (Seconds (0.1));

NS_LOG_INFO ("Adding http traffic: s23->ue23");
  HttpHelper httpHelper_s23_ue23;
  HttpServerHelper httpServer_s23_ue23;  

  httpServer_s23_ue23.SetAttribute ("Local", AddressValue (InetSocketAddress (Ipv4Address::GetAny (), port)));
  httpServer_s23_ue23.SetAttribute ("HttpController", PointerValue (httpHelper_s23_ue23.GetController ()));
  ApplicationContainer httpServerApps_s23_ue23 = httpServer_s23_ue23.Install (s23);
  httpServerApps_s23_ue23.Start (Seconds (0.0));
  httpServerApps_s23_ue23.Stop (Seconds (20.0));

  HttpClientHelper httpClient_s23_ue23;
  httpClient_s23_ue23.SetAttribute ("Peer", AddressValue (InetSocketAddress (interfaces_r2_s23.GetAddress (1), port)));
  httpClient_s23_ue23.SetAttribute ("HttpController", PointerValue (httpHelper_s23_ue23.GetController ()));
  ApplicationContainer httpClientApps_s23_ue23 = httpClient_s23_ue23.Install (ue23);
  httpClientApps_s23_ue23.Start (Seconds (0.1));

NS_LOG_INFO ("Adding http traffic: s13->ue13");
  HttpHelper httpHelper_s33_ue33;
  HttpServerHelper httpServer_s33_ue33;  

  httpServer_s33_ue33.SetAttribute ("Local", AddressValue (InetSocketAddress (Ipv4Address::GetAny (), port)));
  httpServer_s33_ue33.SetAttribute ("HttpController", PointerValue (httpHelper_s33_ue33.GetController ()));
  ApplicationContainer httpServerApps_s33_ue33 = httpServer_s33_ue33.Install (s33);
  httpServerApps_s33_ue33.Start (Seconds (0.0));
  httpServerApps_s33_ue33.Stop (Seconds (20.0));

  HttpClientHelper httpClient_s33_ue33;
  httpClient_s33_ue33.SetAttribute ("Peer", AddressValue (InetSocketAddress (interfaces_r3_s33.GetAddress (1), port)));
  httpClient_s33_ue33.SetAttribute ("HttpController", PointerValue (httpHelper_s33_ue33.GetController ()));
  ApplicationContainer httpClientApps_s33_ue33 = httpClient_s33_ue33.Install (ue33);
  httpClientApps_s33_ue33.Start (Seconds (0.1));
