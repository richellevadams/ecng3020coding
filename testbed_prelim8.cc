...
#include "ns3/drop-tail-ipa-queue.h"
...
int main (int argc, char *argv[])
{
  ...
  if ((queueType != "RED") && (queueType != "DropTail") && (queueType != "IPA"))
    {
      NS_ABORT_MSG ("Invalid queue type: Use --queueType=RED or --queueType=DropTail or --queueType=IPA");
    }
